...
\ead{bitinat2@isu.edu}
\author{John Edwards\corref{cor1}}%\fnref{fn1}}
\ead{edwajohn@isu.edu}
\cortext[cor1]{Corresponding author}
%\fntext[fn1]{Editor-in-Chief, Computers and Graphics Journal.}  

%\address{Idaho State University, 921 S 8th Ave, Pocatello, ID, USA}
\address{Idaho State University, Pocatello, ID, USA}


%\author[label1]{Nathan Morrical}
%\author[label1]{John Edwards\corref{Corresponding author}}
%\address[label1]{Department of Informatics and Computer Science, Idaho State University, USA}
