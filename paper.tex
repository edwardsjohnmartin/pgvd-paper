...
%  \begin{tightenumerate}
  ...
  \item Sort BCells array -  \red{$O(D)$}. We use a parallel radix sort with linear complexity dependent on the max quadtree depth.
...
\begin{table*}
  ...
  \begin{tabular}{lcc|c|cc|cc}
    ...
    Fig. \ref{fig:ut1-samples} & 470 & 4943 & 24 & 87 & 277 & 22355 & 156649  \\

    % ./gvd-viewer2 -l 8 ../data2/glines/100x100/*.dat
    % ./QUADTREE --disable-conflict-color -d 1 -m 4 -l 9 data/glines/100x100/*
    Fig. \ref{fig:vascular} & 2162 & 39,338 & 12 & 84 & 376 & 14338 & 157006  \\
