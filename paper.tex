...
\begin{figure}
  ...
  \caption{
    \protect\subref{fig:simple-conflicts} \red{Incorrect conflict cells.} A toy dataset showing conflict cells after building the quadtree from object vertices.
